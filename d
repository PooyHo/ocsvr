...
_EOF_
    ...
    sed -i "s/max-same-clients = 1/max-same-clients = ${maxsameclients}/g" "${confdir}/ocserv.conf"
    sed -i "s/max-clients = 16/max-clients = ${maxclients}/g" "${confdir}/ocserv.conf"
    sed -i "s/tcp-port = 999/tcp-port = ${port}/g" "${confdir}/ocserv.conf"
    sed -i "s/udp-port = 999/udp-port = ${port}/g" "${confdir}/ocserv.conf"
    ...
    sed -i "s@#ipv4-network = 192.168.8.0/24@ipv4-network = ${vpnnetwork}@g" "${confdir}/ocserv.conf"
    sed -i "s/#dns = 192.168.8.2/dns = ${dns1}\ndns = ${dns2}/g" "${confdir}/ocserv.conf"
